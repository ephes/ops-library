...
- Captures Thread + Matter state (`/var/lib/thread` and any Matter Server storage/chip factory dirs outside `data/`).
...
- `homeassistant_backup_extra_dirs` – additional directories to include in the snapshot.
